...
%========================================
%=========================================
%Testing Heading Colours. It messes up chapter name taking it to the left. hence must 
%discard the following 5 lines when finished with the book
\usepackage{sectsty}
\chapterfont{\color{blue}}  % sets colour of chapters
\sectionfont{\color{cyan}}  % sets colour of sections
\subsectionfont{\color{red}}  % sets colour of sections
\subsubsectionfont{\color{green}}  % sets colour of sections
%============================
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{./tex/myUrduCommandsPhysics.tex}                  %turning latex into urdu
...
%
\includeonly{./tex/prefaceFirstBook,./tex/measurement,./tex/motionAlongStraightLine,./tex/vectors,./tex/motionInTwoAndThreeDimensions,./tex/forceAndMotionA,./tex/forceAndMotionB,./tex/kineticEnergyAndWork,./tex/HR_p07_p08Done,./tex/HR_p09Done,./tex/HR_p10a_10bDone,./tex/HR_p11Done,./tex/HR_p57Done,./tex/potentialEnergyAndConservationOfEnergy,./tex/centerOfMassAndLinearMomentum,./tex/rotation,./tex/RollingTorqueAndAngularMomentum,./tex/equilibriumAndElasticity,./tex/gravitation}%
%
%\includeonly{./tex/rotation}%
%\includeonly{./tex/RollingTorqueAndAngularMomentum}%
%\include{./tex/gravitation}
...
%the following command sets table of contents (toc) right. also must use stared version  \\begin{otherlanguage*}{english}  in text.
\setlatin
...
%\include{./tex/test}
\include{./tex/measurement}
\include{./tex/motionAlongStraightLine}
\include{./tex/vectors}
\include{./tex/motionInTwoAndThreeDimensions}
\include{./tex/forceAndMotionA}
\include{./tex/forceAndMotionB}
\include{./tex/kineticEnergyAndWork}
\include{./tex/potentialEnergyAndConservationOfEnergy}
\include{./tex/centerOfMassAndLinearMomentum}
\include{./tex/rotation}
\include{./tex/RollingTorqueAndAngularMomentum}
\include{./tex/equilibriumAndElasticity}
\include{./tex/gravitation}
