...
%\includeonly{./tex/calculusPreface,./tex/prefaceFirstBook,./tex/quantumTheWaveFunction,./tex/quantumMechanicsTime_independentSchrodingerEquattion,./tex/quantumFormalism,./tex/quantumMechanicsInThreeDimensions,./tex/quantumIdenticalParticles,./tex/quantumTimeIndependentPertubationTheory,./tex/quantumTheVariationalPrinciple,./tex/quantumTheWKBapproximation,./tex/quantumTimeDependentPertubationTheory,./tex/quantumTheAdiabaticApproximation,./tex/quantumScattering,./tex/quantumAfterword}
%
...
%
%\includeonly{./quantumMechanicsPreface,./tex/prefaceFirstBook,./tex/test}%
...
%\include{./tex/test}
\include{./tex/quantumTheWaveFunction}
\include{./tex/quantumMechanicsTime_independentSchrodingerEquattion}
\include{./tex/quantumFormalism}
\include{./tex/quantumMechanicsInThreeDimensions}
\include{./tex/quantumIdenticalParticles}
\include{./tex/quantumTimeIndependentPertubationTheory}
\include{./tex/quantumTheVariationalPrinciple}
\include{./tex/quantumTheWKBapproximation}
\include{./tex/quantumTimeDependentPertubationTheory}
\include{./tex/quantumTheAdiabaticApproximation}
\include{./tex/quantumScattering}
\include{./tex/quantumAfterword}
