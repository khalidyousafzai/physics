...
%
%\includeonly{./tex/calculusPreface,./tex/prefaceFirstBook,./tex/physicsMeasurement,./tex/HR_p07_p08Done,./tex/HR_p09Done,./tex/HR_p57Done,./tex/potentialEnergyAndConservationOfEnergy,./tex/centerOfMassAndLinearMomentum,./tex/rotation,./tex/RollingTorqueAndAngularMomentim}%
%
%\includeonly{./tex/HR_p08bDone}%
%\includeonly{,./tex/rotation}%
\includeonly{,./tex/RollingTorqueAndAngularMomentim}%
...
\include{./tex/RollingTorqueAndAngularMomentim}
