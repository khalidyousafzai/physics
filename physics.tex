...
%
%\includeonly{./tex/calculusPreface,./tex/prefaceFirstBook,./tex/physicsMeasurement,./tex/HR_p57Done,./tex/potentialEnergyAndConservationOfEnergy,./tex/elasticCollisionInOneDimension}%
%
%\includeonly{,./tex/HR_p57Done}%
\includeonly{,./tex/elasticCollisionInOneDimension}%
...
\include{./tex/elasticCollisionInOneDimension}
