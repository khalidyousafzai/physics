...
%
%\includeonly{./tex/calculusPreface,./tex/prefaceFirstBook,./tex/physicsMeasurement,./tex/HR_p07_p08Done,./tex/HR_p09Done,./tex/HR_p10a_10bDone,./tex/HR_p11Done,./tex/HR_p57Done,./tex/potentialEnergyAndConservationOfEnergy,./tex/centerOfMassAndLinearMomentum,./tex/rotation,./tex/RollingTorqueAndAngularMomentum,./tex/equilibriumAndElasticity,./tex/gravitation}%
%
%\includeonly{./tex/HR_p11Done}%
...
%\include{./tex/test}
\include{./tex/physicsMeasurement}
\include{./tex/HR_p07_p08Done}
\include{./tex/HR_p08bDone}
\include{./tex/HR_p09Done}
\include{./tex/HR_p10a_10bDone}
\include{./tex/HR_p11Done}
\include{./tex/HR_p57Done}
