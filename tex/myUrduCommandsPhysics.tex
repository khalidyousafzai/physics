...
%--------------------
%checkpoint
%defining a CheckPoint   آزمائش

%\newcounter{kcpcounter}[section]
%\renewcommand{\thekcpcounter}{\arabic{kcpcounter}}
\newcounter{kcpcounter}[chapter]
%\renewcommand{\thekcpcounter}{\thechapter.\arabic{kcpcounter}}
\renewcommand{\thekcpcounter}{\arabic{kcpcounter}}

\newenvironment*{آزمائش}				
{\par\noindent\ignorespaces  آزمائش \refstepcounter{kcpcounter} \thekcpcounter \par}%
{\par\noindent }
%--------------------
%--------------------
%--------------------
%Sample Problem
%defining a Sample Problem  نمونی سوال

%\newcounter{kspcounter}[section]
%\renewcommand{\thekspcounter}{\arabic{kspcounter}}
\newcounter{kspcounter}[chapter]
\renewcommand{\thekspcounter}{\thechapter.\arabic{kspcounter}}
%\renewcommand{\thekspcounter}{\arabic{kcpcounter}}

\newenvironment*{نمونی سوال}				
{\par\noindent\ignorespaces  نمونی سوال \refstepcounter{kspcounter} \thekspcounter :\quad}%
{\hfill\qedsymbol  \vspace{\baselineskip}\par}
%--------------------
%--------------------
%defining a RULE   قاعدہء

%\newcounter{krucounter}[section]
%\renewcommand{\thekrucounter}{\arabic{krucounter}}
\newcounter{kkrucounter}[chapter]
\renewcommand{\thekkrucounter}{\thechapter.\arabic{kkrucounter}}

\newenvironment*{قاعدہء}				
{\par\noindent\ignorespaces  قاعدہ \refstepcounter{kkrucounter}  :\quad}%
{\par\noindent }
%--------------------
%--------------------
